...
try {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if (!validarNombre($nombre)) {
            ...
            if ($new_register) {
                $sql_insert = "INSERT INTO User (customer_name, user_mail, user_country_id, user_city, user_cp, user_tel, user_tel_prefix, user_pass, encryptString) VALUES (:nombre, :email, :paisid, :ciudad, :cp, :tel, :prefix, :pass, :token )";
